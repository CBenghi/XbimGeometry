...
namespace Xbim.ModelGeometry.Scene
{
	public class XbimPlacementTree
	{
		...
		public XbimPlacementTree(IModel model, IXbimGeometryEngine engine, bool adjustWcs = true)
		{
			...
			var linearPlacements = model.Instances.OfType<Ifc4x3.GeometricConstraintResource.IfcLinearPlacement>(true).ToList();

			ILogger logger;
			var loggerFactory = InternalServiceProvider.GetLoggerFactory();
			logger = loggerFactory.CreateLogger(nameof(XbimPlacementTree));
